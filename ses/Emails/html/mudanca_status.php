...
<div style='height: 1150px;'>
    <div style=" 
        ...
        <div>
            <img src="http://54.207.82.125/stores/docemel/portal/img/docemel/logo.png" id="adv-logo-sup" style="width: 150px;
                 margin-left: 60px;
                 margin-top: 20px;"/>
        </div>
        ...
        <div id="caixa-corpo" style="box-shadow: 0px -3px 5px #ccc;
            ...
            <div id="pedido" style="float: left; margin-left: 10px; margin-top: 10px; font-family: Helvetica;">
                <strong style="color: #555;">PEDIDO 9999</strong>
                <br />
        ...
        <div style="position: absolute; margin-top: 20px; margin-left: 75px; ">
            <span style="color: #3399cc; font-family: Helvetica; font-size: 14px;"><i>Caro Sr(a). XXXXX,</i></span>
            <div style="color:#999; margin-top:15px ;font-size: 12px; font-family: Helvetica;">
                ...
                Confira as informacoes abaixo que constam no seu pedido <strong>nº XXXXX</strong><br />
                realizado em <strong>XX/XX/XX as XX:XX:</strong>
            </div>

            <div style="color:#999; margin-top:15px ;font-size: 12px; font-family: Helvetica;">
                <strong>Detalhes do pedido:</strong><br />
                <span>Forma de Pagamento: XXXXX</span><br />
                <span>Parcelas: XX vez(es) de R$XXX,XX</span><br/>
                <span>Total Frete: R$XX,XX</span><br/>
                <span>Total Desconto: R$XX,XX</span><br/>
                <span>Total Pedido: R$XX,XX</span><br/>
            </div>
            ...
            <div style="margin-top: 60px;">
                <table style="width: 500px; font-size: 12px; color: #999; font-family: Helvetica;">
                    <tr style="width: 100%;">
                        <td style="width: 25%;">Camisa Polo</td>
                        ...
                        <td style="width: 25%; text-align: right;">R$XXX,XX</td>
            ...
            <div style="margin-top: 30px;">
                <div style="color:#999; margin-top:15px ;font-size: 12px; font-family: Helvetica;">
                    ...
                    <span>
                        <strong>
                            A/C XXXXX <br/>
                            Rua XXXXXXX X XXXXX, 9999 apto. 111 - Bairro XXXXX<br/>
                            Sao Paulo - SP - CEP XXXXX-XXX
                        </strong>
                    </span>
                    <br/>
                    <br/>
                    <span>
                        ...
                        <span style="line-height: 13px; font-size: 10px;">O <strong>Prazo de Entrega</strong> de <strong>XX</strong> dias passara a partir da confirmacao do pagamento e sera ralizado pela propria<br/>
                            XPTO. A Loja Doce Mel nao realiza, nem se responsabiliza pela entrega de produtos comercializados atraves do seu <br />
            ...
            <div style="margin-top: 15px; ">
                ...
                <div style="color:#999; font-size: 12px; font-family: Helvetica;">
                    Seu pedido esta <strong>EM APROVACAO</strong> pela instituicao financeira. Assim que for liberado, voce<br/>
                    ...
                    email <span style="color: #3399cc;">atendimento@lojasdocemel.com.br</span>, informando no campo assunto o numero do seu<br/>
                    ...
                    <span>
                        <strong>
                            Empresa XXXX<br/>
                            Rua XXXXXXXXX, 999 <br/>
                            Bairro NONONNON - Sao Paulo - Sp<br/>
                            CEP 00000-000<br/>
                            Telefone: (11)0000-0000<br/>
                            e-mail: <span style="color: #3399cc;">vendas@XPTO.com</span>
                        </strong>
                    </span>
                    <br/><br/>
                    <span style="font-size: 10px;">
                        ...
                        A qualquer momento, voce pode acompanhar o andamento do seu pedido pelo portal <strong>Doce Mel</strong> acessando<br />
                        <span style="color: #3399cc;">www.lojasdocemel.com.br/</span> no menu Minhas Compras. <span style="color: #3399cc;">Clique aqui</span> para verifica agora.
                        <br />
                        <br />
                ...
                <div style="color:#999; margin-top:20px ;font-size: 12px; font-family: Helvetica;">
                    Atenciosamente,<br/>
                    <strong style="color: #999; font-size: 16px;">Equipe Doce Mel</strong><br/>
                    <strong style="color: #999; font-size: 16px;">www.lojasdocemel.com.br</strong>
                </div>

                <div>
                    <img src="http://54.207.82.125/stores/docemel/portal/img/docemel/logo.png" width="100px" style="margin-top: 15px; opacity: 0.4;"/>
                </div>
            </div>
    ...
    <div style="height: 5px; width: 600px; position: absolute; top: 1110px;
         background: #f37165;"></div>
</div>